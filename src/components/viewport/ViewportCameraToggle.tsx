...
export const ViewportCameraToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className={`absolute bottom-[132px] right-3 z-10 h-7 min-w-[52px] px-2 rounded-full border border-ink-200 font-mono text-[11px] uppercase tracking-wide shadow-[0_2px_8px_rgba(35,33,24,0.18)] transition-colors duration-100 ${
        orthographic
