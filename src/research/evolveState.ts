/**
 * E3 frozen-state schema (ruling R2: step mode is state replay, not a
 * prompt change). Lives in src/research so BOTH consumers share one source:
 * the in-app capture (Evolve panel export — approved 2026-08-31) and the
 * headless harness (scripts/research/lib/evolveState.ts re-exports this).
 *
...
import type { Rotation } from '../lib/cube/connectionRules';
import type { OperatorRecord, TranslationPass2 } from '../lib/operators/types';
import { sha256HexOfCanonicalJson } from './hashing';
